...
/**
 * @title Puppy Governance contract
...
/**
 * @title PuppyToken contract
 * @dev This is the implementation of the BEP20 Puppy Token.
 ...
 *
 */
contract PuppyToken is Governed, BEP20, BEP20Burnable {
    using SafeMath for uint256;
    ...
    bytes32
        private constant DOMAIN_SALT = 0x4e621494881f38baf5be3f5cea59349b7fb9ba568d85e7ac80d99bc02f033980; // Randomly generated salt
    ...
    /**
     * @dev Puppy Token Contract Constructor.
     * @param _initialSupply Initial supply 
     */
    constructor(uint256 _initialSupply) BEP20("Puppy Token", "PUP") {
    ...
    function permit(
        ...
        require(_owner == recoveredAddress, "PUP: invalid permit");
        require(_deadline == 0 || block.timestamp <= _deadline, "PUP: expired permit");
